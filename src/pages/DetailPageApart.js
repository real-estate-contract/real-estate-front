...
const DetailPageApart = () => {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6ImVoZG1zMTExNSIsInN1YiI6ImVoZG1zMTExNUBuYXZlci5jb20iLCJpYXQiOjE3MTcwNDA4MTAsImV4cCI6MTcxOTYzMjgxMH0.ySsv_RMGQWhGE5aOzNxC5ztFB2t6GYJ7PrVp_gTMRQs";
  ...
  return (
    <div>
      ...
      <div className="property-info" style={{ marginLeft: "20px" }}>
        ...
        <p>
          방/욕실: {selectedItem.rooms}개/{selectedItem.bathrooms}개
        </p>
